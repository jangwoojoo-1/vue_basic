...
const moveModify = () => {
  router.push({ name: "article-modify", params: { articleno: route.params.articleno } });
};

const onDeleteArticle = () => {
  console.log(route.params.articleno + "번글 삭제하러가자!!!");
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="clearfix align-content-center">
              ...
              />
              <p>
                <span class="fw-bold">서유미</span> <br />
                <span class="text-secondary fw-light">
                  {{ article.registerDate }}1 조회 : {{ article.hit }}
                </span>
              </p>
            </div>
          </div>
